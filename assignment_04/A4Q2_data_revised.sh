...
# I used your notes from your announcement to clean the original files and used 
# those for my code - I sorted the cleaned specs and copied them over the 
# original specs file. I also copied the cleaned sales file and copied it
# over the original sales file.

paste tractor_sales.csv -d ',' tractor_specs.csv > A4Q2a_full.csv
...
# I used the code below to remove the first column of the specs .csv, saved
# is as a test file, and copied it over the original before joining it to sales
# cut -d ',' -f 2-5 tractor_specs.csv > tractor_specs_test.csv
# I then used the cleaning process you provided again to make sure the files
# would join without any errors.

join tractor_sales.csv -t ',' tractor_specs.csv > A4Q2b_full.csv
...
Rscript A4Q2_data.R > A4Q2_results.out
