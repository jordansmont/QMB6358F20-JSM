...
beta_0_hat_calc <- mean(y) - (beta_1_hat_calc * mean(x))

print(beta_0_hat_calc)
...
### NOTES TO SELF FOR FUTURE REFERENCE: "par" is the initial values for the starting point
### for the program to estimate the beta vector, "fn" is the function to be optimized,
### "y" is the y value and "x" is the x value.
